    ...
    <div class="video_ls clear"  ref="videoLs">
      <div class="video_shows" v-for="(item,index) in srclist">
        <div v-if="item.imsrc" class="div_videos" >
          <img :src="item.imsrc+'.jpg'" :ref="index"/>
        </div>
...
export default {
    data() {
      return {
        ...
        refslist:[],//对象列表
        srclist:[//视频图片列表
          {imsrc:'https://surmon-china.github.io/vue-quill-editor/static/images/surmon-1'},
          {videosrc:"http://59.80.44.91/vjs.zencdn.net/v/oceans.mp4"} ,
          {imsrc:'https://surmon-china.github.io/vue-quill-editor/static/images/surmon-1'},
